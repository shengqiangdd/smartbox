...
[![Build](https://github.com/shengqiangdd/cloudhub/actions/workflows/ci.yml/badge.svg)](https://github.com/shengqiangdd/cloudhub/actions)
...
```bash
# 1. 克隆仓库
git clone https://github.com/shengqiangdd/cloudhub.git
cd cloudhub
...
> 💡 Docker 镜像由 GitHub Actions 自动构建并推送至 **ghcr.io/shengqiangdd/cloudhub**，每次推送 `main` 分支都会自动更新 `latest` 标签。
